...
public class AuthentificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.inputCodeLayout);
        //define views here
        ...
        resendCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(AuthentificationActivity.this, "Code renvoyé", Toast.LENGTH_SHORT).show();
                retryVerify();
            }
        });
        ...
        if (cancel) {
            ...
            new CountDownTimer(45000, 1000) {
                ...
                public void onFinish() {
                    timer.setText(0 + " s");
                    resendCode.startAnimation(AnimationUtils.loadAnimation(AuthentificationActivity.this, R.anim.slide_from_right));
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                Toast.makeText(AuthentificationActivity.this, "Invalid Verification Code", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                });
